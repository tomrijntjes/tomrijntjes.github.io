...
*October 2024 - January 2025, Woerden*

At a bootstrapped energy startup, I:

- Oversaw an outsourcing team that built a fully functional energy management web portal.
- Tackled scalability challenges by designing and implementing a robust batch processing platform.
- Led the development of net electricity consumption forecasting models.
- Managed investor and stakeholder communications on our tech roadmap and risk strategy.

**Programming**: C#, Python

**Data**: SQL Server, Delta Lake

**Infrastructure**: Azure Cloud, Azure Data Factory, Azure Batch

### **Eneco**/Tech Lead

*March 2024 - September 2024, Rotterdam*
